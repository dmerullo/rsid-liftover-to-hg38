...
# use the UMichigan tool to get the merged rsids in hg38 for the unmapped rsids from hg36
...
# get a final list of rsids that properly merged from hg36 to hg38
...
Rscript $PATH_TO/table-hg36-hg38.R > 03-table.log 2> 03-table.err
